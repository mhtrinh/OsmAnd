...
public class NotificationHelper {
	...
	private SpeedAlertNotification speedAlertNotification;
	...
	private void init() {
		...
		speedAlertNotification = new SpeedAlertNotification(app);
		...
		all.add(speedAlertNotification);
	...
	private List<OsmandNotification> acquireTopNotifications(@Nullable Service service) {
		...
		if (speedAlertNotification.isEnabled(service)) {
			res.add(speedAlertNotification);
		}
		return res;
	}
