...
public class OsmandSettings {
	...
	public final CommonPreference<Boolean> SPEED_ALERT_ENABLED = new BooleanPreference(this, "speed_alert_enabled", false).makeProfile().cache();
	public final CommonPreference<Integer> SPEED_ALERT_THRESHOLD_KMH = new IntPreference(this, "speed_alert_threshold_kmh", 5).makeProfile().cache();
	public final CommonPreference<Integer> SPEED_ALERT_FALLBACK_KMH = new IntPreference(this, "speed_alert_fallback_kmh", 100).makeProfile().cache();
